...
class PubChemQADataset:
    def __init__(self, output_prefix: str = "chemistry_qa_dataset"):
        ...
        self.fg_smarts_list = [
            ...
            'thiol', 'nitrile', 'carbamate', 'urea', 'guanidine']
        ]
    ...
    def qa_from_dataframe(self):
        ...
        for idx, row in self.df.iterrows():
            ...
            # 7. SMILES Generation
            if name and canonical_smiles:
                qa_list.append({
                    'question': f"What is the **canonical SMILES** string for the compound named **{name}**?",
                    'answer': canonical_smiles,
                    'cid': cid,
                    'answer_source': 'iupac_to_smiles_conversion'
                })
